...
import static com.example.moviefavorite.AdapterFavorite.POSTER_PATH;
...
public class ActivityDetilFilm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvtglrilis.setText(String.format("%s %s", getResources().getString(R.string.tanggal_rilis), modelFilm.getTanggal()));
        tvBahasa.setText(String.format("%s %s", getResources().getString(R.string.bahasa), bahasa(modelFilm)));
        tvdeskripsi.setText(modelFilm.getDeskripsi());
        Glide.with(this)
                .load(POSTER_PATH + "w500" + modelFilm.getPoster())
