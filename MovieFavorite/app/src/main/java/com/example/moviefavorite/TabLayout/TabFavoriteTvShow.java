...
public class TabFavoriteTvShow extends Fragment {
    ...
    private static TabFavoriteTvShowViewModel viewModelTabTv;

    public static TabFavoriteTvShow newInstance() {
        return new TabFavoriteTvShow();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.tab_favorite_tv_show_fragment, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        viewModelTabTv = new ViewModelProvider(getActivity(), new ViewModelProvider.NewInstanceFactory()).get(TabFavoriteTvShowViewModel.class);
        viewModelTabTv.setListFavorite(getActivity());

        viewModelTabTv.getListFavorite().observe(getActivity(), new Observer<List<ModelFilm>>() {
            @Override
    ...
    public static class DataObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            viewModelTabTv.setListFavorite(context);
