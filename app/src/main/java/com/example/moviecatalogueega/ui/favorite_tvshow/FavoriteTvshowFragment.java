...
public class FavoriteTvshowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_favorite_tvshow, container, false);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final ViewModel_favoriteTvshowFragment viewModel_favoriteTvshowFragment = new ViewModelProvider(getActivity(), new ViewModelProvider.NewInstanceFactory()).get(ViewModel_favoriteTvshowFragment.class);
        viewModel_favoriteTvshowFragment.setListTvFavorite(getContext());
        viewModel_favoriteTvshowFragment.getListTv().observe(getActivity(), new Observer<List<ModelFilm>>() {
            @Override
